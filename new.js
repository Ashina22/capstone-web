...
async function initMap() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "(DOST-Caraga) promotes scientific and technological advancements to drive innovation and development in the Caraga region"
    },
    {
    ...
    },
    {
      ...
      link: "lib.html",
      icon: "img/college.png", // Specific icon for this location
      description: "The Caraga State University (CSU) HERO Learning Commons the largest library in the Caraga region" 
    },
    {
    ...
    },
    {
      ...
      link: "caa.html",
      icon: "img/college.png", // Specific icon for this location
      description: "Provides education, research, and training in agriculture and agri-industrial technologies to support sustainable development" 
    },
    {
      ...
      icon: "img/college.png", // Specific icon for this location
      link: "cofes.html",
      description: "Focuses on education, research, and sustainable practices in forestry and environmental sciences"
    },
    {
      ...
      icon: "img/college.png", // Specific icon for this location
      link: "chass.html",
      description: "CHASS offers programs in the arts, humanities, and social sciences, fostering critical thinking and cultural awareness"
    },
    {
    ...
    },
    {
      ...
      link: "ccis.html",
      icon: "img/college.png", // Specific icon for this location
       description: "(CCIS) specializes in computing, information technology, and data sciences, preparing students for the digital industry"
    },
    {
      ...
      link: "cegs.html",
      icon: "img/college.png", // Specific icon for this location
      description: "Offers programs in engineering and geosciences, focusing on technological innovation and sustainable development"
    },
    {
      ...
      link: "ced.html",
      icon: "img/college.png", // Specific icon for this location
      description: "CED prepares future educators through quality teaching, research, and community engagement in the field of education"
    },
    {
    ...
    },
    {
      ...
      link: "oatc.html",
      icon: "img/dpt.png", // Specific icon for this location
      description: "OATC provides training, research, and advocacy for sustainable and organic farming practices" 
    },
    {
      ...
      link: "hostel.html",
      icon: "img/college.png", // Specific icon for this location
      description: "This facility includes the university clinic" 
    },
    {
      ...
      description: "Oversees athletic programs, facilities, and events, promoting physical fitness and sports development within the university"
    },
    {
    ...
    {
      position: { lat: 8.955018346783993, lng: 125.5969820861699 },
     info: "Eco Hall",
...
function searchLocation() {
  ...
  if (found.length > 0) {
    ...
    "oas": {  lat: 8.95689685581763, lng: 125.59717054069868, info: "OAS", image: "img/oas.jpg", link: "nsb-canteen.html", description: "Office of admission and scholarship" },
      ...
      "anex 2 building": { lat: 8.954527524733473, lng:  125.59807198444454, info: "Anex 2 Building", image: "img/anex.jpg", link: "http://example.com/anex" },
      "anex 3 building": { lat: 8.956476963908328, lng: 125.59541117924815, info: "Anex 3 Building", image: "img/anex.jpg", link: "anex1.html" }, 
      "csu villares building": { lat: 8.953157960469824,  lng: 125.59738112140803, info: "CSU Villares Building", image: "img/cofes.jpg", link: "" },   
...
async function getDirections() {
  ...
  const searchLocations = {
    ...
    "new administration building": { lat: 8.957250380365862,  lng: 125.59764832350852,  info: "New Administration Building", image: "img/admin.jpg", link: "admin.html" },
      "anex 2 building": { lat: 8.954527524733473, lng:  125.59807198444454, info: "Anex 2 Building", image: "img/anex.jpg", link: "http://example.com/anex" },  
      "anex 3 building": { lat: 8.956476963908328, lng: 125.59541117924815, info: "Anex 3 Building", image: "img/anex.jpg", link: "anex1.html" },  
      "csu villares building": { lat: 8.953157960469824,  lng: 125.59738112140803,  info: "CSU Villares Building", image: "img/cofes.jpg", link: "cofes.html" }, 
      "csu main hero learning commons": { lat: 8.95786387399443,  lng: 125.59635007361663, info: "CSU Main HERO Learning Commons", image: "img/library.jpg", link: "lib.html" },
      "old cas building": { lat: 8.955575598052341, lng: 125.59664046282884, info: "Old CAS Building", image: "img/oldcas.jpg", link: "oldcas.html" },
      "college of computing and information sciences (ccis)": { lat: 8.9554, lng: 125.5978, info: "College of Computing and Information Sciences (CCIS)", image: "img/ccis.jpg", link: "ccis.html" },
      "field": { lat: 8.956543619178424,  lng: 125.59649493048896, info: "Field", image: "img/oval.jpg", link: "field.html" },
...
<label><input type="checkbox" value="img/college.png" checked> Colleges</label><br>
<label><input type="checkbox" value="img/canteen.png" checked> Canteens</label><br>
<label><input type="checkbox" value="img/dpt.png" checked> Departments</label><br>
<label><input type="checkbox" value="img/plant.png" checked> Plants</label><br>
<label><input type="checkbox" value="img/sports.png" checked> Sports</label><br>
<label><input type="checkbox" value="img/default-marker.png" checked> Default</label><br>
</div>